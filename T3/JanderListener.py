...
class JanderListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by JanderParser#programa.
    def enterPrograma(self, ctx:JanderParser.ProgramaContext):
        pass

    # Exit a parse tree produced by JanderParser#programa.
    def exitPrograma(self, ctx:JanderParser.ProgramaContext):
        pass
    ...
    # Enter a parse tree produced by JanderParser#decl_local_global.
    def enterDecl_local_global(self, ctx:JanderParser.Decl_local_globalContext):
        pass

    # Exit a parse tree produced by JanderParser#decl_local_global.
    def exitDecl_local_global(self, ctx:JanderParser.Decl_local_globalContext):
        pass
